...
description: "Add persistent context, business rules, and domain knowledge to SQLsaber. Improve SQL query accuracy with database-specific memories."
---
...
For richer, searchable, structured context, use the [Knowledge Base](/guides/knowledge).
...
2. [Add searchable structured context with knowledge](/guides/knowledge)
3. [Manage conversation threads](/guides/threads) with consistent context
4. [Explore different models](/guides/models) and see how they use memory
5. [Review the command reference](/reference/commands) for all memory options
