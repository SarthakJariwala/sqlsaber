...
2. **AI authentication** — Sign in to your AI provider; credentials are stored in your OS keychain

<Aside type="tip">
Have a Claude Pro/Max subscription? You can use it with SQLsaber—no separate API key needed.
</Aside>
