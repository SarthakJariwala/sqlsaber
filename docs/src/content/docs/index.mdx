...
description: "Open-source CLI tool that converts natural language to SQL. Query PostgreSQL, MySQL, SQLite, and DuckDB databases by asking questions in plain English. Schema-aware, read-only by default, with knowledge retrieval and conversation threads."
template: splash
hero:
