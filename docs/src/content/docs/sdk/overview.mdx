...
- `await saber.draft_handoff(goal)` creates a handoff draft from the conversation's history; include the [bundled handoff capability](/sdk/capabilities/#bundled-handoff) in your options.
...
4. [Advanced](/sdk/advanced/) for capability models, custom prompts, and write access
