...
COMMAND_SPECS: tuple[CommandSpec, ...] = (
    ...
    _management(("plugins", "list"), "List installed plugins.", "/plugins list"),
    _management(
        ("plugins", "show"),
        "Show effective plugin settings and sources.",
        "/plugins show NAME",
        takes_arguments=True,
    ),
    _management(
        ("plugins", "setup"),
        "Configure a plugin for future sessions.",
        "/plugins setup NAME [--set FIELD=VALUE] [--advanced] [--yes]",
        options=(
            _option("--set", repeatable=True),
            _option("--advanced", takes_value=False),
    ...
    _management(
        ("plugins", "set"),
        "Change a saved plugin setting.",
        "/plugins set NAME FIELD VALUE [--yes]",
        options=(_option("--yes", takes_value=False),),
        takes_arguments=True,
    ),
    _management(
        ("plugins", "unset"),
        "Restore a plugin setting's default.",
        "/plugins unset NAME FIELD [--yes]",
        options=(_option("--yes", takes_value=False),),
        takes_arguments=True,
    ),
    _management(
        ("plugins", "enable"),
        "Enable a plugin for future sessions.",
        "/plugins enable NAME [--yes]",
        options=(_option("--yes", takes_value=False),),
        takes_arguments=True,
    ),
    _management(
        ("plugins", "disable"),
        "Disable a plugin for future sessions.",
    ...
    _management(
        ...
        "/models set [MODEL] [--thinking-level LEVEL]",
        group_alias="model",
        options=(_option("--thinking-level"),),
        takes_arguments=True,
    ),
    _management(
        ("models", "current"),
